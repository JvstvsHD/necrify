...
ALTER TABLE punishment.necrify_punishment
    ADD CONSTRAINT fk_punishment_user FOREIGN KEY (uuid) REFERENCES punishment.necrify_user (uuid);
ALTER TABLE punishment.necrify_whitelist
    DROP CONSTRAINT IF EXISTS fk_whitelist_user;
ALTER TABLE punishment.necrify_whitelist
    ADD CONSTRAINT fk_whitelist_user FOREIGN KEY (uuid) REFERENCES punishment.necrify_user (uuid);
